...
const mapProfile = (row) => ({
  ...
  placementTestCompletedAt: row.placement_test_completed_at,
  placementTestScore: row.placement_test_score,
...
const editableProfileFields = {
  ...
  placementTestCompletedAt: 'placement_test_completed_at',
  placementTestScore: 'placement_test_score',
